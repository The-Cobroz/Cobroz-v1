    ...
    return (
        <div>
            ...
            <form onSubmit={saveChanges}>
                ...
                <h6>Change your Speciality</h6>
                <div>
                    <input
                        name='majorIn'
                        type='text'
                        value={details.majorIn}
                        placeholder= {details.majorIn}
                        onChange={handleChange}
                    />
                </div>
